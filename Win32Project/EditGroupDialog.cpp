...
void EditGroupDialog::CreateControls()
{
	...
	SetSizer(sizer);
    wxStaticText * codeLabel = new wxStaticText(this, wxID_ANY, _("Code:"));
    ...
    wxTextCtrl * codeEdit = new wxTextCtrl(this, ID_EGD_CODE_TEXTCTRL, wxEmptyString);
	wxTextCtrl * nameEdit = new wxTextCtrl(this, ID_EGD_NAME_TEXTCTRL, wxEmptyString);
	wxTextCtrl * descriptionEdit = new wxTextCtrl(this, ID_EGD_DESCRIPTION_TEXTCTRL, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE);


	ImagePicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, wxT("Select a File"));

	codeEdit->SetValidator(wxGenericValidator(&GroupCode));
...
const wxString & EditGroupDialog::GetGroupCode()
{
    return GroupCode;
}
