...
wxPostgresActiveRecord::wxPostgresActiveRecord(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password):wxActiveRecord(table,name,server,user,password){
	m_database=NULL;
	Create(table,name,server,user,password);
}
...
bool wxPostgresActiveRecord::Create(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password){
	if(m_database!=0){
		delete m_database;
		m_database=0;
	}
...
wxMysqlActiveRecord::wxMysqlActiveRecord(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password):wxActiveRecord(table,name,server,user,password){
	m_database=NULL;
	Create(table,name,server,user,password);
}
...
bool wxMysqlActiveRecord::Create(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password){
	if(m_database!=0){
		delete m_database;
		m_database=0;
	}
...
wxFirebirdActiveRecord::wxFirebirdActiveRecord(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password):wxActiveRecord(table,name,server,user,password){
	m_database=NULL;
	Create(table,name,server,user,password);
}
...
bool wxFirebirdActiveRecord::Create(const wxString& table,const wxString& name,const wxString& server,const wxString& user,const wxString& password){
	if(m_database!=0){
		delete m_database;
		m_database=0;
	}
